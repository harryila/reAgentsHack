...
ALLOWLIST_FILES = (
    ...
    "scripts/evaluate_evidence_inference_diagnostic.py",
    "scripts/evaluate_evidence_inference_ollama.py",
    "scripts/evaluate_human_review.py",
    ...
    "docs/adaptive-calibration-contract.md",
    "docs/adaptive-stress-study.md",
    "docs/calibration.md",
    "docs/claim-release.md",
    "docs/closed-corpus-evaluation.md",
    "docs/evidence-graph.md",
    "docs/evidence-inference-benchmark.md",
    "docs/evidence-inference-local-ollama-gepa.md",
    "docs/evidence-inference-local-ollama.md",
    "docs/evidence-inference-provider-free-diagnostic.md",
    "docs/local-benchmark-suite.md",
    "docs/meta-analysis.md",
    "docs/metasyn-screening-study.md",
    "docs/native-antiox-local-ollama.md",
    "docs/native-grounding.md",
    ...
    "docs/pipeline-item-risk-calibration.md",
    "docs/reproducibility-v2.md",
    ...
    "prompts/evidence_inference_gepa_seed.md",
    ...
    "configs/benchmarks/local-suite-v1.json",
    ...
    "tests/test_adaptive_calibration.py",
    "tests/test_adaptive_online_redteam.py",
    "tests/test_adaptive_stress_study.py",
    "tests/test_audit_session.py",
    "tests/test_calibrate_item_risk_cli.py",
    "tests/test_certificate_v5_redteam.py",
    "tests/test_claim_release.py",
    "tests/test_closed_corpus.py",
    "tests/test_evidence_graph.py",
    "tests/test_evidence_inference_diagnostic.py",
    "tests/test_evidence_inference_ollama.py",
    "tests/test_evidence_inference_ollama_reporting.py",
    "tests/test_gepa_pilot_summary.py",
    "tests/test_harvester_validation.py",
    "tests/test_human_review.py",
    "tests/test_item_risk_calibration.py",
    "tests/test_local_benchmark_suite.py",
    ...
    "tests/test_metasyn_retrieval_study.py",
    "tests/test_metasyn_screening_study.py",
    "tests/test_native_extraction.py",
    "tests/test_native_grounding.py",
    "tests/test_native_ollama_diagnostic.py",
    "tests/test_ollama_gepa_study.py",
    "tests/test_pipeline_fingerprint.py",
    "tests/test_prompt_optimization.py",
    "tests/test_question_evaluation.py",
    "tests/test_sequential_verification.py",
    "tests/test_source_manifest_bridge.py",
...
EXCLUDED_SCOPES = (
    ...
    "checkout-wide public-artifact validator and its tests; the scrubbed source archive "
    "intentionally omits several registered data bundles",
